<%@ Page Title="" Language="C#" MasterPageFile="~/MobileSongShe/songshe.Master" AutoEventWireup="true" CodeBehind="SongSheEnvironment.aspx.cs" Inherits="Maticsoft.Web.MobileSongShe.SongSheEnvironment" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        $(function () {
            $("#navul li a").eq(3).addClass("current");
            $(".logo").html("颂玺环境");
        });
    </script>
    <style>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="pagecontent">
        ...
        <div id="wztf" class="wztf">
            ...
            <div class="tfimg">
                <img src="<%=pc==null?"":pc.ImgUrl %>" onerror="this.src='/Image/h_35.jpg'" />
            </div>
        </div>
        <div id="gztf" class="gztf">
            ...
            <%--图片尺寸建议：width:570px;height:540px;--%>
            <div class="tfimg">
                <img src="<%=pc==null?"":pc.ImgUrl %>" onerror="this.src='/Image/h_36.jpg'" />
            </div>
        </div>
        <div style="clear: both;"></div>
    </div>
