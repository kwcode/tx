<%@ Page Title="" Language="C#" MasterPageFile="~/MobileSongShe/songshe.Master" AutoEventWireup="true" CodeBehind="SongSheBrand.aspx.cs" Inherits="Maticsoft.Web.MobileSongShe.SongSheBrand" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/MobileSongShe/CSS/SongSheBrand.css" rel="stylesheet" />
    <script>
        $(function () {
            $("#navul li a").eq(1).addClass("current");
            $(".logo").html("颂玺品牌");
            $(".doctorlist .descript").dotdotdot();
        });
    </script>
</asp:Content>
