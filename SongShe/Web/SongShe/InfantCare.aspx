<%@ Page Title="" Language="C#" MasterPageFile="~/SongShe/songshe.Master" AutoEventWireup="true" CodeBehind="InfantCare.aspx.cs" Inherits="Maticsoft.Web.SongShe.InfantCare" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="/CSS/InfantCare.css" rel="stylesheet" />
    <script>
        $(function () {
            $(".nav li.linav").eq(1).find(".parentnav").addClass("currenta");
        });
    </script>
</asp:Content>
