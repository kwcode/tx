<%@ Page Title="" Language="C#" MasterPageFile="~/SongShe/songshe.Master" AutoEventWireup="true" CodeBehind="MonthOfMeals.aspx.cs" Inherits="Maticsoft.Web.SongShe.MonthOfMeals" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        $(function () {
            $(".nav li.linav").eq(3).find(".parentnav").addClass("currenta");
        });
    </script>
    <style>
        .title {
            ...
            <div>
                <ul>
                    ...
                    <li>
                        ...
                        <div class="swimg">
                            <img src="<%=pcontent.ImgUrl %>" onerror="$(this).hide();" /></div>
                    </li>
                    <%} %>
                    <%--<li>
                        <div class="descript">
